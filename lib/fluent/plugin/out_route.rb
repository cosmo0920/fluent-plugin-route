...
module Fluent::Plugin
  class RouteOutput < Output
    ...
    class Route
      ...
      config_param :remove_tag_prefix, :string, default: nil, deprecated: "use @label instead for event routing"
      config_param :add_tag_prefix, :string, default: nil, deprecated: "use @label instead for event routing"
